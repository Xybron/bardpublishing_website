    ...
    <main class="w-screen h-screen grid grid-cols-1 place-items-center  md:grid-cols-2 bg-green-50">
        ...
        <div class="px-8 md:px-25 ">
            <div class="max-w-lg text-black">
                              <div class="my-5 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                ...
                <p class="mb-8 animate-fade-in leading-relaxed text-gray-700">
                    In today’s fast-paced digital world, parenting comes with new challenges—and opportunities. In Parenting Digital Natives, author Aubrey Richards provides a practical and insightful guide to raising children in the age of screens, social media, and smart devices.
                </p>
                <div>
                    <Button
