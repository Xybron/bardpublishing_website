<template>
 <section
  class="relative py-12 bg-gray-900 sm:py-16 lg:py-20 xl:py-24 bg-cover bg-no-repeat bg-center bg-[url('/imgs/bg_library_3.jpg')]">
  
  <!-- Dark overlay -->
  <div class="absolute inset-0 bg-black/70"></div>

  <div class="relative z-10 px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
    <div class="max-w-2xl mx-auto text-center">
      <p class="text-base font-semibold text-green-500">Subscribe for free</p>
      <h2 class="mt-6 text-3xl font-title font-semibold text-white sm:text-4xl lg:text-5xl lg:mt-8">
    ...
    <form
      action="#"
      method="POST"
      class="flex flex-col justify-between max-w-lg mx-auto mt-12 rounded-full sm:items-center sm:border sm:border-white sm:p-1 sm:flex-row sm:mt-16 sm:focus-within:border-green-500 sm:focus-within:ring-1 sm:focus-within:ring-green-500">
  ...
  <footer class="relative py-12 sm:py-16 bg-black overflow-hidden bg-cover bg-no-repeat bg-right"
    style="background: linear-gradient(to left, rgba(0, 0, 0, 0.85) 40%, rgba(0, 0, 0, 1) 90%), url('/imgs/bg_library_2.jpg');">
    <div class="px-6 mx-auto sm:px-8 lg:px-12 max-w-7xl relative z-10">
      <div class="grid grid-cols-1 gap-y-12 xl:grid-cols-3 xl:gap-8">
        ...
        <div class="xl:col-span-1">
          ...
          <p class="mt-6 text-sm text-white">contact@bardpublishing.com</p>
